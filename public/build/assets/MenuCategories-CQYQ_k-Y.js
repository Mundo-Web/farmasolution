import{j as t}from"./AboutSimple-Cf8x2fCZ.js";import{r as n}from"./index-BOnQTV8N.js";import{t as $}from"./MobileMenu-CelZvc7k.js";import"./index-yBjzXJbu.js";import"./_commonjsHelpers-D6-XlEtG.js";import"./main-DKOTUah5.js";import"./___vite-browser-external_commonjs-proxy-DDYoOVPM.js";import"./BasicRest-BCYKfs4R.js";import"./index-DRg3WPTA.js";import"./index-C0Swrixi.js";import"./index-fNjTmf9T.js";const J=({pages:I=[],items:c,data:k,visible:f=!1})=>{const[d,j]=n.useState([]),[A,N]=n.useState(0),[F,S]=n.useState(!1),[R,M]=n.useState(!0),[b,C]=n.useState(0);n.useRef(null);const u=n.useRef(null),x=e=>{if(e){const r=e.scrollLeft<=10,a=e.scrollLeft>=e.scrollWidth-e.clientWidth-10;S(!r),M(!a);const i=e.scrollWidth-e.clientWidth,s=i>0?e.scrollLeft/i*100:0;C(Math.min(100,Math.max(0,s)))}};n.useEffect(()=>{const e=document.createElement("style");return e.textContent=`
            .scrollbar-invisible {
